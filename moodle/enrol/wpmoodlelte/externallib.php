...
class enrol_wpmoodlelte_external extends external_api {
    ...
    public static function enrol_user_parameters() {
        return new external_function_parameters(
            array(
                ...
                'invoice_id' => new external_value(PARAM_RAW, 'Invoice Id', VALUE_DEFAULT, NULL),
                'date' => new external_value(PARAM_RAW, 'Date', VALUE_DEFAULT, NULL),
                'status' => new external_value(PARAM_RAW, 'Status', VALUE_DEFAULT, NULL),
                'amount' => new external_value(PARAM_RAW, 'Amount', VALUE_DEFAULT, NULL),
                'download_invoice' => new external_value(PARAM_RAW, 'Download Invoice', VALUE_DEFAULT, NULL),
            )
        );
    }
     ...
     * @throws moodle_exception
     */
    public static function enrol_user($courseid, $instanceid = 0, $name, $email, $mobile, $invoice_id = null, $date = null, $status = null, $amount = 0, $download_invoice = null) {
        global $CFG, $DB;
        ...
        $response = $enrol_class->create_new_wpmoodlelte($course->id, $name = $params['name'], $email = $params['email'], $amount = $params['amount'], $mobile = $params['mobile'], $params['invoice_id'], $params['status'], $params['date'], $params['download_invoice']);
            ...
            array(
                ...
                'data' => new external_single_structure(
                    array(
                        ...
                        'due_date' => new external_value(PARAM_TEXT, 'Due Date'),
                        'mobile' => new external_value(PARAM_TEXT, 'User\'s Mobile'),
                        'name' => new external_value(PARAM_TEXT, 'User Name'),
                        'total_amount' => new external_value(PARAM_TEXT, 'Total Amount'),
